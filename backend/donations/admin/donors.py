...
class DonorAdmin(ModelAdmin):
    ...
    actions_list = ("schedule_redirections_stats_generator", "schedule_redirections_stats_generator_force")
    ...
    def schedule_redirections_stats_generator(self, request, queryset: QuerySet[Donor]):
        call_command("schedule_redirections_stats_generator")

    @action(description=_("Schedule redirections stats [FORCE]"), url_path="schedule-redirections-stats-generator-f")
    def schedule_redirections_stats_generator_force(self, request, queryset: QuerySet[Donor]):
        call_command("schedule_redirections_stats_generator", "--force")
