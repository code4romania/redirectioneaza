...
HEADER_ITEMS: Dict[str, Dict[str, str]] = {
    ...
    #     "static_icon": "star",
    #     "subtitle": _(
    #         "Ce este formularul 230? " "Cine poate redirecționa? " "Cum poți contribui? " "Care sunt regulile?"
    #     ),
    # },
    "faq_ngo": {
    ...
    "faq_user": {
        ...
        "url": reverse("faq"),
        "static_icon": "question-mark-circle",
        "subtitle": _("Ce se întâmplă cu datele tale? Ce altceva? Găsește răspunsurile la întrebările tale."),
    },
    # "contact": {
    #     "title": _("Contact"),
    #     "url": reverse("contact"),
    #     "static_icon": "mail",
    #     "subtitle": _("Pagina formular contact pentru donatori."),
    # },
    # "user_guide": {
    #     "title": _("User guide"),
