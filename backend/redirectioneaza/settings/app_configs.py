...
FORM_COUNTIES_WITH_SECTORS_LIST = list(BUCHAREST_SECTORS + FORM_COUNTIES_WITH_SECTORS)
FORM_COUNTIES_WITH_SECTORS_CHOICES = [(county, county) for county in FORM_COUNTIES_WITH_SECTORS_LIST]
