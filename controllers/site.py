...
class HomePage(BaseHandler):
    ...
    def get(self):
        ...
        if self.is_ikea_subdomain:
            ...
            cez_ngos = [
                'asociatia-little-people-romania/doilasuta',
                'doilasuta',
                'the-social-incubator/doilasuta',
                'code-for-romania',
                'fundatianoiorizonturi/doilasuta',
                'fundatia-sf-dimitrie/doilasuta',
                'world-vision-romania/doilasuta',
                'asociatia-habitat-for-humanity-romania/doilasuta',
                'niciodatasingur/doilasuta',
                'asociatia-vatra-cu-idei',
                'fundatia-progress',
                'yesromania',
                'fundatia-alex-tache/doilasuta',
                'fundatia-principesa-margareta-a-romaniei',
                'httpwwwsalvaticopiiirodoilasuta/doilasuta',
                'asociatia-roi',
                'asociatia-vasiliada',
