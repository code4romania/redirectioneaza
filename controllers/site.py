    ...
    def get(self):
        ...
        if self.is_ikea_subdomain:
            ...
            nesle_ngos = [
                ...
                'asociatia-ana-si-copiii',
                'asociatia-animal-societyy',
                'asociatia-ateliere-fara-frontiere',
                'asociatia-blondie',
                'asociatia-centrul-step-by-step-pentru-educatie-si-dezvoltare-profesionala',
                'asociatia-ecoassist-iniiativa-plantam-fapte-bune-in-romaniageeks',
                'asociatia-edit',
                'asociatia-habitat-for-humanity-romania',
                ...
                'asociatia-pavel',
                'asociatia-pentru-educatie-digitala-bigger-picturepreocupati-de-viitor',
                ...
                'daruieste-viata',
                'forumapulum',
                'fundatia-adapostul-sperantafundatia-romanian-angel-appeal',
                'fundatia-comunitara-bucuresti',
                ...
                'fundatia-pactfundatia-regala-margareta-a-romaniei',
                'fundatia-serviciilor-sociale-bethany',
                'fundatiaenescu',
                'fundatianoiorizonturi',
                'giftedgrowupromania',
                'httpwwwsalvaticopiiirodoilasutasor',
                'izvorulalb',
                'junior-achievement-romania',
                'mihaieminescutrustorganizatia-umanitara-concordia',
                'ovidiuro',
                'padureacopiilor',
                'rolda',
                'sos-satele-copiilor-romania',
